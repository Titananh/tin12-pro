// ==========================================
// Academy Cockpit Layout — Navbar & Footer
// Tin12 Pro Cánh Diều
// ==========================================
'use client';
    ...
    <header className="navbar glass-panel--sticky">
      <div className="navbar__inner">
        ...
        <div className="navbar__actions">
          <div className="navbar__stat navbar__stat--streak" title="Chuỗi học tập">
          ...
          <div className="navbar__stat navbar__stat--xp" title="Điểm kinh nghiệm">
            <svg className="navbar__stat-icon" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
          ...
          <Link href="/dashboard" className="navbar__avatar focus-ring" aria-label="Hồ sơ — Minh">
            M
          </Link>
        </div>
      ...
      >
        <nav className="navbar__mobile-links container" aria-label="Điều hướng di động">
          {navLinks.map(({ href, label, Icon }) => (
            <Link
              key={href}
              href={href}
    ...
    <footer className="footer" role="contentinfo">
      ...
      <div className="footer__bottom">
        <p className="footer__copy">
          &copy; 2026 Tin12 Pro Cánh Diều. Mọi quyền được bảo lưu.
        </p>
        <p className="footer__copy">
